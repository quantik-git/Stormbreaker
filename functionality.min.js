bodyElement=$("body");$mainElement=$("main");bodyLayoutClass=$("body").attr("class");if(bodyLayoutClass==="basic-sidebar-left"){$sidebar=$(".sidebar-left");$side="left";$openSign=">";$closeSign="<";$sidebarToggleButton=$(".btn-sidebar-left")}else if(bodyLayoutClass==="basic-sidebar-right"){$sidebar=$(".sidebar-right");$side="right";$openSign="<";$closeSign=">";$sidebarToggleButton=$(".btn-sidebar-right")}
if(bodyLayoutClass!=="basic"){distanceTop=$mainElement.position().top;if(bodyElement.width()<481){$sidebar.css($side,0);$sidebar.css("top",distanceTop)}
